...
{
    public partial class TestUserCode
    {
        /// <summary>
        ...
        public void TestUserCodeCS()
        {
                	
    	string filePath_Expected = @"W:\HBDaily\InstallAutomation\Script\Reports\DiffBetweenServWsBIN.txt";
    	string filePath_Current = @"W:\HBDaily\InstallAutomation\Script\Reports\DiffBetweenServWsBIN.txt";
